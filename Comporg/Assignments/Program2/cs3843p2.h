...
int encrypt(char *psbInBuffer, int iInBufferLgth, char *pszKey, char *psbOutBuffer
    , int iOutMaxBufferLgth);
int decrypt(char *psbInBuffer, int iInBufferLgth, char *pszKey, char *psbOutBuffer
    , int iOutMaxBufferLgth);
